...
#Using yahoo finance to see the stock prices of any company using streamlit between fixed dates.
...
with col1:
    start_date = st.date_input("Enter start date", datetime.date(2018, 1, 1))

with col2:
    end_date = st.date_input("Enter end date", datetime.date(2021, 12, 31))
